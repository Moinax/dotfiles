...
| Toggle all herdr sessions | `Mod+Alt+A` | Any herdr client window open → detach all (servers/agents keep running); none open → open every running session as one tabbed Hyprland group |
